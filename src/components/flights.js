            ...
            <div className="flight-container">
              {/* <div>
                <img
                  ...
                  src={
                    ...
                    `_200_50_r.png?md5apikey=VDjfGgv8mxiTvvLLwGicD6V2eq`
                  }
                  alt="Airline logo"
                />
              </div> */}
              ...
              <div className="flight-name">
                ...
                {flight.itineraries[0].segments.map((segment) => (
                  <li key={segment.id}>
                    <b>{segment.carrierCode}</b> {segment.number}
                  </li>
                ))}
                <br />
              ...
              <div className="flight-deets-box">
                <li className="flight-deets">
                  <b>{flight.itineraries[0].segments[0].departure.iataCode}</b>{" "}
                  {flight.itineraries[0].segments[0].departure.at.toString()}
                </li>
                {flight.itineraries[0].segments.map((segment) => (
                  <li className="flight-deets" key={segment.id}>
                ...
                <button
                  ...
                  onClick={() =>
                    selectFlight(
                      flight.price.total,
                      flight.itineraries[0].segments[0].departure.at.toString(),
                      flight.itineraries[0].segments[0].arrival.at.toString(),
                      flight.itineraries[0].segments[0].carrierCode,
